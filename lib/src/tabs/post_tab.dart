...
import 'package:room_finder/src/screens/post_map_selector.dart';
...
class _PostTabState extends State<PostTab> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<PostLocationProvider>(
      builder: (context, postLocationProvider, child) {
        return Container(
          child: ListView(
                      ...
                      CustomButton(
                        title: Row(
                          children: [
                            ...
                            Text(
                                postLocationProvider.getSelectedLocation == null
                                    ? 'Add Location'
                        ...
                        pressed: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              ...
                              maintainState: true,
                              builder: (context) => PostMapSelector(),
                            ),
                          );
                        },
                      ),
                      ...
                      Wrap(
                        children: [
                          RawMaterialButton(
                            ...
                            child: Container(
                              width:
                                  MediaQuery.of(context).size.width / 3 - 15.0,
                              height:
                                  MediaQuery.of(context).size.width / 3 - 15.0,
  ...
  submitAd() async {
    if (formKey.currentState.validate()) {
      if (file1 == null && file2 == null && file3 == null && file4 == null) {
        ...
        return;
      } else if (context.read<PostLocationProvider>().getSelectedLocation ==
          null) {
        CustomNotification(
      ...
      try {
        ...
        LatLng locationLatLng =
            context.read<PostLocationProvider>().getSelectedLocation;
